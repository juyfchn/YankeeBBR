...
installbbr(){
	...
	wget -O headers-all.deb http://vir.jufxf.kiwi/linux-headers-4.10.15-041015_4.10.15-041015.201705080411_all.deb
...
startbbr(){
	...
	wget -O ./tcp_tsunami.c http://vir.jufxf.kiwi/tcp_tsunami.c
